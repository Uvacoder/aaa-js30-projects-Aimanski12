...
export const addImage = (data) => {
  return dispatch => {
    dispatch(setSpinner())
    fetch('https://us-central1-camera-proj.cloudfunctions.net/storeImage', {
      method: "POST", 
      body: JSON.stringify({
        imageId: data.base64
      })
    ...
    .then(parsedRes => {
      ...
      return fetch('https://camera-proj.firebaseio.com/images.json', {
        method: 'POST',
...
export const getImageHandler = () => {
  return dispatch => {
    fetch('https://camera-proj.firebaseio.com/images.json')
...
export const changeImageName = (id, name) => {
  ...
  return dispatch => {
    fetch('https://camera-proj.firebaseio.com/images/'+ id +'/imageName' +'.json/', {
      method: "PUT",
...
export const deleteImage = (imageId) => {
  return dispatch => {
    fetch('https://camera-proj.firebaseio.com/images/' + imageId + '.json/', {
      method: 'DELETE'
    })
    .catch(err=> console.log(err))
      .then(res => {return res.json()})
