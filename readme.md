...
> I currency converter app are one of the app ideas that really interest me most. I build this app to see how does the currency app works under the hood. All the data from this app are taken from [API Frankfurter](https://www.frankfurter.app/) and [Rest Countries](https://restcountries.eu/).
